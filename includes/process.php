...
if (isset($_POST["order_date"]) AND isset($_POST["cust_name"])) {
	...
	$m = new Manage();
	echo $result = $m->storeCustomerOrderInvoice($orderdate,$cust_name,$ar_tqty,$ar_qty,$ar_price,$ar_pro_name,$sub_total,$tax,$discount,$net_total,$paid,$due,$payment_type);
