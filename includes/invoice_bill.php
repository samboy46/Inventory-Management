...
if ($_GET["order_date"] && $_GET["invoice_no"]) {
	...
	$pdf->Cell(40,10,"Total (GBP)",1,1,"C");
	...
	$pdf->Cell(50,10,"VAT Tax",0,0);
	$pdf->Cell(50,10,": ".$_GET["tax"],0,1);
    ...
    $pdf->Cell(140,10,"Signature",0,0,"R");
    $pdf->Cell(140,10,"____________________",0,1);
