	...
	public function userLogin($email,$password){
		...
		if ($result->num_rows < 1) {
			...
			if (password_verify($password,$row["password"])) {
				...
				//Here we are updating user last login time 
...
//$user = new User();
//echo $user->createUserAccount("Test","edebak1@gmail.com","1234567890","Admin");
   
//echo $user->userLogin("edebak1@gmail.com","1234567890");
