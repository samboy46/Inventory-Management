	...
	<div class="container">
		...
		<!--<tr>
		    ...
		    <td>Rs.1540</td>
                    ...
                    <div class="form-group row">
                      <label for="tax" class="col-sm-3 col-form-label" align="right">VAT(20%)</label>
                      <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="number" value="0.00" name="discount" class="form-control form-control-sm" id="discount" required/>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="number" value="0.00" name="paid" class="form-control form-control-sm" id="paid" required>
                      </div>
                    </div>
                    <div class="form-group row">
